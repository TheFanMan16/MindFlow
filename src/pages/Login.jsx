...
/** GitHub mark, monochrome via currentColor. */
const GitHubIcon = () => (
...
/** Discord mark, monochrome via currentColor. */
const DiscordIcon = () => (
  <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
const Login = () => {
  ...
  // error (handlers null the error before setting it, so `error` transitions).
